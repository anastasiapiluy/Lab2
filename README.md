...
Считаем количество цифр в числе (k), создаем массив длины k, в цикле добавляем каждую цифру числа в список (разбиваем число по цифрам и рассматриваем как элементы списка). Потом проходимся по массиву и сравниваем элементы с начала и с конца попарно : если все пары равны - число является палиндромом, если нет - не является.
...
Создается массив длины n, вводится n элементов массива. Проходимся по массиву, для каждого элемента считаем сумму цифр, затем во вложенном цикле считаем количество появлений элемента в массиве. Далее смотрим, равна ли сумма цифр количеству появлений, не встречалось ли данное число раньше, проходя по списку все элемены до этого, если все верно, выводим число. Если не одного числа не было выведено, то выводим "NO".
