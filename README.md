...
Суть последовательности в том, что задается нулевой член, к которому прибавляется 3 (результат будет следующим членом последовательности), а потом делится на 4 (с округлением в меньшую сторону).
